 ...
 *
 */
public class TreatEditor extends JFrame implements ActionListener{
	...
	private JList list;
	private JRadioButton rdbtnTreatments;
	...
	public TreatEditor(int nSimPort, String sSessId, String sProcId, boolean bDebug) {
		...
		springLayout.putConstraint(SpringLayout.SOUTH, panel_1, -406, SpringLayout.SOUTH, getContentPane());
		...
		rdbtnTreatments = new JRadioButton("Treatments");
		sl_panel_2.putConstraint(SpringLayout.WEST, scrollPane, 0, SpringLayout.WEST, rdbtnTreatments);
		sl_panel_2.putConstraint(SpringLayout.WEST, rdbtnTreatments, 10, SpringLayout.WEST, panel_2);
		sl_panel_2.putConstraint(SpringLayout.NORTH, rdbtnTreatments, 0, SpringLayout.NORTH, panel_2);
		panel_2.add(rdbtnTreatments);

		rdbtnDrafts = new JRadioButton("Drafts");
		sl_panel_2.putConstraint(SpringLayout.WEST, rdbtnDrafts, 10, SpringLayout.WEST, panel_2);
		sl_panel_2.putConstraint(SpringLayout.NORTH, rdbtnDrafts, 6, SpringLayout.SOUTH, rdbtnTreatments);
		...
		sl_panel_2.putConstraint(SpringLayout.NORTH, lblFrom, 4, SpringLayout.NORTH, rdbtnTreatments);
		panel_2.add(lblFrom);
		...
		sl_panel_2.putConstraint(SpringLayout.NORTH, textFromMonth, 1, SpringLayout.NORTH, rdbtnTreatments);
		...
		sl_panel_2.putConstraint(SpringLayout.NORTH, lblTo, 4, SpringLayout.NORTH, rdbtnTreatments);
		panel_2.add(lblTo);

		textToMonth = new JTextField();
		sl_panel_2.putConstraint(SpringLayout.EAST, lblTo, -6, SpringLayout.WEST, textToMonth);
		sl_panel_2.putConstraint(SpringLayout.NORTH, textToMonth, 1, SpringLayout.NORTH, rdbtnTreatments);
		...
		sl_panel_2.putConstraint(SpringLayout.NORTH, textFromDay, 1, SpringLayout.NORTH, rdbtnTreatments);
		...
		sl_panel_2.putConstraint(SpringLayout.NORTH, textToDay, 1, SpringLayout.NORTH, rdbtnTreatments);
		...
		sl_panel_2.putConstraint(SpringLayout.NORTH, textToYear, 1, SpringLayout.NORTH, rdbtnTreatments);
		...
		sl_panel_2.putConstraint(SpringLayout.NORTH, textFromYear, 1, SpringLayout.NORTH, rdbtnTreatments);
		...
		sl_panel_2.putConstraint(SpringLayout.NORTH, btnClearSearch, 0, SpringLayout.NORTH, btnOpenSelect);
		sl_panel_2.putConstraint(SpringLayout.WEST, btnClearSearch, 10, SpringLayout.WEST, panel_2);
		...
		btnClearSearch.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				rdbtnTreatments.setSelected(false);
		...
		btnViewAllTreatments.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				String id1 = syscaller.getIdOfEntityWithNameAndType("Treatments", "b");
				String[] results;
				List<String> newResults = new ArrayList<String>();
				String sType = "b";
				String sGraphType = "ac";
				List<String[]> members = syscaller.getMembersOf("Treatments", id1, sType, sGraphType);
	...
	public void openAll() {
		...
		if(rdbtnTreatments.isSelected()){
			...
			reader.setTitle("Treatment Drafts");
			for(int j = 0; j < found.size(); j++){
	...
	public static void createGUI(){
		TreatEditor draft = new TreatEditor(simport, sessid, pid, debug);
		draft.pack();
	...
	class SaveDraftAlt extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e){
			...
			String sContainers = "b|Drafts,b|TreatmentDrafts";
	...
	class SubmitToTreatments extends AbstractAction{
		...
		public void actionPerformed(ActionEvent e){
			...
			if(sObjName.length() == 0){
				...
				String sContainers = "b|PatTreatment,b|Treatments";
				...
				//if the treatment has been saved as a draft and already has a treatment number	
				...
				String sProp1 = "Drafts";
				String sContainer1 = "PatTreatment";
				System.out.println(sContainer1 + " " + sProp1);
				String sContainer2 = "Treatments";
				String sProp2 = "TreatmentDrafts";
				...
				/*
				boolean cmd = syscaller.deleteAssignment(sObjName, "Drafts", "b");
				System.out.println("deleting " + sObjName + " from " + sProp1);
				if(!cmd){
					System.out.println("DELETEASSIGNEMNT didn't work 1");
					JOptionPane.showMessageDialog(null, "DELETE ASSIGNMENT DIDNT WORK");
					return;
				}
				*/
				...
				String sHandle = syscaller.createObject3(sObjName, "File", "rtf",
						"b|PatTreatment,b|Treatments", "File read", null, null, null, null);
	...
	class SearchAction extends AbstractAction{
		...
		public void search(){
			...
			if(rdbtnTreatments.isSelected() && rdbtnDrafts.isSelected()){
				JOptionPane.showMessageDialog(TreatEditor.this, "Only select one");
				return;
			}else if(!rdbtnTreatments.isSelected() && !rdbtnDrafts.isSelected()){
				JOptionPane.showMessageDialog(TreatEditor.this, "Please select Drafts or Treatments");
				return;
			}

			if(sel.length() == 0){
				JOptionPane.showMessageDialog(TreatEditor.this, "Please select one");
				return;
			}
			if(sel.equals("treatments")){
				...
				String id1 = syscaller.getIdOfEntityWithNameAndType("TreatmentDrafts", "b");

				String sType = "b";
				String sGraphType = "ac";
				List<String[]> members = syscaller.getMembersOf("TreatmentDrafts", id1, sType, sGraphType);
	...
	class OpenAction extends AbstractAction{	
		...
		public void select(){
			...
			if(nSelIx < 0){
				JOptionPane.showMessageDialog(TreatEditor.this, "Select a result");
				return;
			}
			...
			mrnField.setText(props.getProperty("tn"));
			...
			myEditorPane.setText(props.getProperty("treatment"));
